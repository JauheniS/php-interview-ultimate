---
title: '20. PSR Standards'
sidebar_label: '20. PSR Standards'
---

# 20. PSR Standards

The PHP Framework Interop Group (PHP-FIG) develops PHP Standard Recommendations (PSR) to help developers write interoperable code.
